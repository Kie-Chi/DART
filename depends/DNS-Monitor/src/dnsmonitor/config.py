...
class TrafficConfig:
    ...
    enable: bool = True  # Set to False to disable traffic monitoring
    interface: Optional[str] = None
    pcap_dir: str = "pcap"
    write_pcap: bool = True  # Set to False to disable pcap writing (display only)
...
class ConfigManager:
    ...
    def load_from_file(self, config_file: str) -> None:
        ...
        try:
            ...
            # Always set traffic interface from CIDR, regardless of whether traffic block exists
            if 'traffic' in data:
